...
export const DEFAULT_WORKSPACE_PLANS = [
  {
    id: 'starter',
    name: 'Starter',
    price: 4000,
...
export const DEFAULT_TRUSTED_VENUES = [
  'Garden City Mall',
  'Gikomba Market',
...
export const DEFAULT_ABOUT_CONTENT = {
  ...
  story:
    'We built FlowFi for operators who were tired of juggling disconnected tools for WiFi sales, router management, support, and reporting. The goal is simple: make it easy for a venue to go from offering guest WiFi to operating connectivity as a measurable business channel.',
  values: [
...
export const DEFAULT_PLATFORM_CONTENT = {
  ...
  workspacePlans: DEFAULT_WORKSPACE_PLANS,
  trustedVenues: DEFAULT_TRUSTED_VENUES,
  reviews: DEFAULT_REVIEWS,
  about: DEFAULT_ABOUT_CONTENT,
  contact: DEFAULT_CONTACT_DETAILS,
